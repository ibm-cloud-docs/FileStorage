...
{{site.data.keyword.cloud}}'s data centers are paired into primary and remote combinations in every region worldwide. When you replicate data, consider the local data residency laws because moving data across borders can have legal implications. See Table 1 for the complete list of data center availability and replication targets within each region. Replication across regions is not permitted.
