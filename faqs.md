...
[^ depdup]: Dependent duplicate caveat (Dependent duplicates can be refreshed immediately after creation.)

[^ indepdup]: Independent duplicate caveat (Independent duplicates can be refreshed after the separation process completes.)
