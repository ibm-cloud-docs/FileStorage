...
1. In the **Snapshot Schedules** frame on the **Details** page click on the schedule to be deleted.
2. Next to the schedule to be deleted, click in the checkbox  and click **Save**.<br/>
