...
| VPC Storage - \n 3 IOPS per GB tier| It's designed for ggeneral-purpose workloads such as workloads that host small databases for web applications or store virtual machine disk images for a hypervisor. |  99.999999999% \n (11 9's) | 99.999%  \n (5 9's) | [Provider-managed AES-256 encryption + Customer-managed encryption](/docs/vpc?topic=vpc-file-storage-vpc-about#FS-encryption) |
