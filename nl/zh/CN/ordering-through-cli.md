...
# 通过 SL CLI 订购 {{site.data.keyword.filestorage_short}}
...
有关如何安装和使用 SL CLI 的更多信息，请参阅 [Python API 客户机 ](https://softlayer-python.readthedocs.io/en/latest/cli.html){:new_window}。
{:tip}
...
缺省情况下，总共可以供应 250 个 {{site.data.keyword.filestorage_short}} 卷。要增加卷的数量，请联系销售代表。有关提高限制的更多信息，请参阅[管理存储限制](managing-storage-limits.html)。
{:important}
