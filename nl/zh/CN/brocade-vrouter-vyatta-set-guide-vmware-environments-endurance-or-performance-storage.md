...
接下来，在两个 Brocade vRouter (Vyatta) 上的结合接口将链接到环境中的子网。请记住将 {{site.data.keyword.BluSoftlayer_full}} VLAN（1101、1102 和 1103）替换为您环境中相应的 VLAN。而且，显示 `<>` 的指示信息必须替换为您环境的详细信息（除去 `<>`）。
