...
1. 登录到 [IBM Cloud 控制台](https://console.bluemix.net/catalog/){:new_window}，然后单击左上角的**菜单**图标。选择**经典基础架构**。
...
1. 登录到 [IBM Cloud 控制台](https://{DomainName}/catalog/){:new_window}，然后单击左上角的**菜单**图标。选择**经典基础架构**。
