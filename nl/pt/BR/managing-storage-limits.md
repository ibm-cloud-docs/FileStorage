...
[{{site.data.keyword.slportal}} ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://control.softlayer.com/){:new_window}. Quando a solicitação for aprovada, você obterá um limite de volume configurado para um data center específico.  
...
*Por exemplo, sua resposta pode ser algo semelhante a um novo VMware Datastore, a um novo ambiente de desenvolvimento e teste (desenv./teste), a um banco de dados SQL ou à criação de log.*
...
- **Forneça uma estimativa de quando você espera/planeja provisionar todo o aumento de volume solicitado.** <br />
