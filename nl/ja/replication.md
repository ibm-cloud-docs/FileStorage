...
2. **「レプリカ」**をクリックし、**「レプリケーションの購入 (Purchase replication)」**をクリックします。
...
**「ストレージ」**>**「{{site.data.keyword.filestorage_short}}」**の下の「{{site.data.keyword.filestorage_short}}」ページでレプリケーション・ボリュームを確認できます。 ボリューム名には、プライマリー・ボリュームの名前とそれに続いて REP が表示されます。 **「タイプ」**は、「エンデュランス - レプリカ」または「パフォーマンス - レプリカ」です。
