...
パブリック Virtual Server のネットワーク使用量合計にストレージ・トラフィックが含まれます。 [Virtual Server の資料](https://{DomainName}/docs/vsi/vsi_public.html#public-virtual-servers)を参照し、サービスによって課せられる可能性がある制限について把握してください。
