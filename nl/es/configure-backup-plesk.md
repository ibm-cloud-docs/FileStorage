...
Para obtener más información del proveedor, consulte [Documentación de Plesk para realizar copias de seguridad y restauraciones ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://docs.plesk.com/en-US/12.5/administrator-guide/backing-up-and-restoration.59256/){:new_window}.
{:tip}
