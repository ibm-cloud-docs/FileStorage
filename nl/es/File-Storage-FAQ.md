...
<table>
  <caption>La Tabla 1 muestra el número máximo de inodes permitidos según el tamaño del volumen. Los tamaños de volumen están en la columna de la izquierda. El número de inodes/comparticiones de archivo está a la derecha.</caption>
  <thead>
    <tr>
