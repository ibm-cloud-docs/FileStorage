...
### Utilización de instantáneas de {{site.data.keyword.filestorage_short}} de Resistencia
...
Restaurar el volumen de {{site.data.keyword.filestorage_short}} de Resistencia requiere apagar todas las máquinas virtuales del {{site.data.keyword.filestorage_short}} de Resistencia. El volumen se debe desmontar temporalmente de los hosts de ESXi para evitar la corrupción de datos durante el proceso.

Para obtener más detalles sobre configurar instantáneas, consulte el artículo sobre [instantáneas](snapshots.html).


### Utilización de réplica de resistencia
...
### 2. Configuración del host de VMware.
...
### 3. Adición de un adaptador de enlace ascendente a un conmutador virtual
...
### 4. Configuración del direccionamiento estático de ESXi (Opcional)
...
##  Montaje de un volumen de {{site.data.keyword.filestorage_short}} en los hosts de ESXi
