...
### Utilisation des instantanés {{site.data.keyword.filestorage_short}} Endurance
...
### 2. Configuration de l'hôte VMware
...
##  Montage de volume {{site.data.keyword.filestorage_short}} sur des hôtes ESXi
