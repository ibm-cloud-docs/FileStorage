...
3. Cliquez sur le nom de la réplique du partage de fichiers dans la liste.
4. Sur la page des détails****, faites défiler l'écran, sélectionnez un instantané existant, puis cliquez sur **Actions** > **Dupliquer**.
...
7. Cliquez sur **Passer une commande** pour mettre le doublon à disposition.
...
6. Cliquez sur **Passer une commande** pour mettre le doublon à disposition.
