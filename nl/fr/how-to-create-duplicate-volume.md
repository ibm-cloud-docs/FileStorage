...
>**Remarque** - Si vous êtes utilisateur d'un compte dédié {{site.data.keyword.containerlong}}, découvrez les options dont vous disposez pour dupliquer un volume dans la [documentation {{site.data.keyword.containerlong_notm}}](/docs/containers/cs_storage_file.html#backup_restore).
