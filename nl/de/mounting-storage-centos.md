...
Wenn Sie Mountoperationen für {{site.data.keyword.filestorage_full}} unter CentOS 7 durchführen möchten, müssen Sie zuerst über die [{{site.data.keyword.cloud}}-Konsole](https://{DomainName}/classic){: external} oder die SLCLI die entsprechenden Berechtigungen für den Host einrichten. Installieren Sie dann die NFS-Dienstprogramme wie in [{{site.data.keyword.filestorage_short}} unter Linux anhängen](/docs/infrastructure/FileStorage?topic=FileStorage-mountingLinux) beschrieben.
