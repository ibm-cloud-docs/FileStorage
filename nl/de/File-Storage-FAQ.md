...
Wenn Speicher gelöscht wird, werden alle Verweise auf die Daten in diesem Datenträger entfernt, sodass kein Zugriff auf die Daten mehr möglich ist. Wenn der physische Speicher erneut für ein anderes Konto bereitgestellt wird, wird eine neue Gruppe von Verweisen zugeordnet. Es besteht keine Möglichkeit für das neue Konto, auf Daten zuzugreifen, die sich auf dem physischen Speicher befanden. Die neue Gruppe von Verweisen zeigt ausschließlich Nullen (0) an. Die neuen Daten überschreiben alle nicht zugänglichen Daten, die auf dieser physischen Speichereinheit vorhanden waren.
