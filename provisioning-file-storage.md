...
1. Log in to [The IBM Cloud catalog](https://console.bluemix.net/catalog/){:new_window} and click **Storage**. Then, select {{site.data.keyword.filestorage_short}}. Click **Create**.
   ...
   Alternatively, you can log into the [{{site.data.keyword.slportal}}](https://control.softlayer.com/){:new_window} }, click **Storage** > **{{site.data.keyword.filestorage_short}}**. In the upper right, click **Order {{site.data.keyword.filestorage_short}}**.
