...
keywords: File Storage, file storage, nsf, provisioning, ordering,
...
6. Select the IOPS tier that your application needs.
    ...
    - **10 IOPS per GB** is designed for the most demanding workloads such as those created by NoSQL databases, and data processing for Analytics. This tier is available in [select data centers](/docs/infrastructure/FileStorage?topic=FileStorage-news) for storage that is provisioned up to 4 TB.
