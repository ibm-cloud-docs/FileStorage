...
You can provision {{site.data.keyword.filestorage_short}} Storage and fine tune to meet your capacity and IOPS needs. Get the most out of your storage with two options for specifying performance.
